...
public class ForgotPass2 implements ActionListener {
    JFrame frame;
    JPasswordField userField;
    JButton userButton;
    JButton exitButton;
    JButton loginimg;
    JLabel userLabel;
    ...
    ForgotPass2(Account[] acc, int count) {
        this.count = count;
        ...
        userLabel = new JLabel("Enter new password");
        userLabel.setBounds(40, 80, 180, 50);
        Font userLabelFont = new Font("Verdana", Font.PLAIN, 17);
        ...
        ImageIcon fnext = new ImageIcon(getClass().getResource("confirm.png"));
